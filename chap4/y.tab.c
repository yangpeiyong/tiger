...
/* Line 1806 of yacc.c  */
#line 83 "tiger.y"
    { (yyval.exp) = A_IfExp(EM_tokPos, (yyvsp[(1) - (3)].exp), (yyvsp[(3) - (3)].exp), A_NilExp(0)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 84 "tiger.y"
    { (yyval.exp) = A_IfExp(EM_tokPos, (yyvsp[(1) - (3)].exp), A_IntExp(0, 1), (yyvsp[(3) - (3)].exp)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 144 "tiger.y"
    {(yyval.dec) = A_Fundec(EM_tokPos, S_Symbol((yyvsp[(2) - (7)].sval)), (yyvsp[(4) - (7)].fieldList), S_Symbol(""), (yyvsp[(7) - (7)].exp)); }
    break;
